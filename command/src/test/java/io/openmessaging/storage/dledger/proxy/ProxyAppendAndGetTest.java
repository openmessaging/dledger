...
import io.openmessaging.storage.dledger.command.ServerTestBase;
import io.openmessaging.storage.dledger.command.ServerTestHarness;
...
public class ProxyAppendAndGetTest extends ServerTestHarness {
    ...
    public void testThreeServerInOneDLedgerProxyInMemory() throws Exception {
        ...
        int port = ServerTestBase.nextPort();
    ...
    public void testThreeProxyEachCarryThreeServerInMemory() throws Exception {
        ...
        int port1 = ServerTestBase.nextPort();
        int port2 = ServerTestBase.nextPort();
        int port3 = ServerTestBase.nextPort();
