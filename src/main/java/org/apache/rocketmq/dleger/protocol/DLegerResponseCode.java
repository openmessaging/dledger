...
public enum  DLegerResponseCode {
    ...
    NOT_LEADER(402, ""),
    NOT_FOLLOWER(403, ""),
    INCONSISTENT_STATE(404, ""),
    INCONSISTENT_TERM(405, ""),
    INCONSISTENT_INDEX(406, ""),
    INCONSISTENT_LEADER(407, ""),
    INDEX_OUT_OF_RANGE(408, ""),
    ILLEGAL_ARGUMENT(409, ""),
    REPEATED_REQUEST(410, ""),
    REPEATED_PUSH(411, ""),
    DISK_ERROR(412, ""),
    INTERNAL_ERROR(500, ""),
    TERM_CHANGED(501, ""),
